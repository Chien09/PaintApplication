...
public class EllipseShape implements IShape {
    ...
    //Constructor
    public EllipseShape(PaintCanvasBase paintCanvas, Point minPoint, Point maxPoint, ShapeType ShapeTYPE, ShapeShadingType ShadingType, Color primaryColor, Color secondaryColor){
